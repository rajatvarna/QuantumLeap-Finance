...
const TranscriptsViewContent: React.FC<TranscriptsViewProps> = ({ ticker }) => {
    ...
    if (!transcript) {
        return <div className="text-center text-text-secondary p-4 bg-card border border-border rounded-xl shadow-sm">No recent earnings call transcript found for this stock.</div>;
    }
